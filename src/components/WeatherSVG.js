    ...
    return (
        <div>
            <svg className='weather_svg' xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="100%" height="100%" viewBox="0 0 903.81496 419" xmlnsXlink="http://www.w3.org/1999/xlink">
                <g>
                    <text className='fs-2' x="24" y="43" fill="black">Min: { minTemp }&#176;{ unitTemp }</text>
                    <text className='fs-2' x="182" y="43" fill="black">Max: { maxTemp }&#176;{ unitTemp }</text>
                ...
                <text className='fs-1' x="406" y="265" fill="black">Feels like</text>
                    <text className='display-1 fw-bold' x="120" y="350" fill="black">{ temperature }&#176;{ unitTemp }</text>
                    <text className='display-1 fw-bold' x="406" y="350" fill="black">{ feelsLike }&#176;{ unitTemp }</text>
                    <text className='fs-4' x="18" y="200" fill="black">Time { currentTime }</text>
                    <FiSunrise className='fs-1 sunrise' x="220" y="175" />
                    <text className='fs-4' x="270" y="200" fill="black">{ mySunriseTime }</text>
                    <FiSunset className='fs-1 sunset' x="450" y="175" />
                    <text className='fs-4' x="500" y="200" fill="black">{ mySunsetTime }</text>
                ...
                {/* <path d="M290.09252,406a1,1,0,0,1-1-1V329a1,1,0,0,1,2,0v76A1,1,0,0,1,290.09252,406Z" transform="translate(-148.09252 -240.5)" fill="#e6e6e6"/>
                <path d="M403.09252,405a1,1,0,0,1-1-1V328a1,1,0,0,1,2,0v76A1,1,0,0,1,403.09252,405Z" transform="translate(-148.09252 -240.5)" fill="#e6e6e6"/>
                <path d="M522.09252,405a1,1,0,0,1-1-1V328a1,1,0,0,1,2,0v76A1,1,0,0,1,522.09252,405Z" transform="translate(-148.09252 -240.5)" fill="#e6e6e6"/>
                <path d="M635.09252,405a1,1,0,0,1-1-1V328a1,1,0,0,1,2,0v76A1,1,0,0,1,635.09252,405Z" transform="translate(-148.09252 -240.5)" fill="#e6e6e6"/> */}
